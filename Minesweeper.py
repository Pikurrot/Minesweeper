...
#Set parameters
difficulty = 0.15 # Easy: 0.10, Moderate: 0.15, Hard: 0.2 (value between 0-1)
map_size.x, map_size.y = 30, 30
random_seed = randint(100000) #or choose seed
...
mine_flagged_img,no_mine_img = pyimg.load('Images/tile_mine.png'),pyimg.load('Images/tile.png'),pyimg.load('Images/tile0.png'),pyimg.load('Images/tile1.png'),\
pyimg.load('Images/tile2.png'),pyimg.load('Images/tile3.png'),pyimg.load('Images/tile4.png'),pyimg.load('Images/tile5.png'),pyimg.load('Images/tile6.png'),\
pyimg.load('Images/tile7.png'),pyimg.load('Images/tile8.png'),pyimg.load('Images/tile_flag.png'),pyimg.load('Images/tile_mine_finded.png'),\
pyimg.load('Images/tile_mine_flagged.png'),pyimg.load('Images/tile_no_mine.png')
...
class Map():
	...
	def __init__(self):
		...
		#Put mines
		self.mine_num = max(round(map_size.x*map_size.y*difficulty), 0)
		mine_num_copy = copy.deepcopy(self.mine_num)
		while mine_num_copy > 0:
...
#Game loop
blockPrint() #Delete this if you want to print the process
running = True
updated = True
...
for y_pos,row in enumerate(grid_view):
	for x_pos,value in enumerate(row):
		if grid_view[y_pos,x_pos] == None or grid_view[y_pos,x_pos] == 'mine':
			...
			hidden_num -= 1
print('starting mines:',Map.mine_num)
